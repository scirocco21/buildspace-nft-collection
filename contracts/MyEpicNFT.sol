...
// This is our SVG code. All we need to change is the word that's displayed. Everything else stays the same.
  ...
  string[] firstWords = ["Alien", "Crimson", "Subterranean", "Gnostic", "Celestial", "Undisclosed", "Clandestine", "Vanished", "Black", "Homeopathic", "Surreptitious", "Parallel", "Lucid"];
  ...
  function makeAnEpicNFT() public {
    ...
    console.log("CombinedWord is: ", combinedWord);
        ...
        bytes(
            string(
                abi.encodePacked(
                    ...
                    combinedWord,
                    '", "description": "A classified collection of nefarious government activity.", "image": "data:image/svg+xml;base64,',
